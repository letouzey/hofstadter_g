...
\innerblock{Theorem:}{
For all $k\ge 0$, when $n\to\infty$ we have $F_k(n) = \tau_k.n + o(n)$
}
...
\vspace*{-3cm}
\begin{center}
\includegraphics[height=1.5em]{by.png}\ \ Pierre Letouzey, 2023
\end{center}
}
...
\altinnerblock{Definition: the substitutions $\sigma_k$}{
\begin{equation*}
\begin{cases}
...
\altinnerblock{Definition: the morphic words $m_k$}{
