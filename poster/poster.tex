...
\author{Pierre Letouzey (équipes Picube / Preuves et Programmes)}
\institute{IRIF, Université Paris Cité / INRIA / CNRS}
\maketitle
...
\innerblock{Definition: the $f_k$ function}{
\begin{align*}
f_k(0) &= 0 \\
f_k(n) &= n - f_k^{(k+1)}(n-1)) & \text{for all}\ n>0
\end{align*}
}}
